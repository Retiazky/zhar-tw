...
function SocialSection() {
  return (
    <ThemedView style={styles.stepContainer}>
      ...
      <SocialProfilesList address={'0x2247d5d238d0f9d37184d8332aE0289d1aD9991b'} client={client} />
    </ThemedView>
  );
}
  ...
  return (
    <ThemedView style={styles.stepContainer}>
      <View style={{ gap: 2 }}>
        ...
        <ThemedText type="subtext">Hook to read contract data, with auto refetching.</ThemedText>
      </View>
      <View style={{ gap: 2 }}>
        <ThemedText>
          Contract name: <ThemedText type="defaultSemiBold">{nameQuery.data}</ThemedText>{' '}
        </ThemedText>
        <ThemedText>
          Supply:{' '}
          <ThemedText type="defaultSemiBold">{supplyQuery.data?.toString()}</ThemedText>{' '}
        </ThemedText>
      </View>
    </ThemedView>
  );
  ...
  return (
    <ThemedView style={styles.stepContainer}>
      <View style={{ gap: 2 }}>
        ...
        <ThemedText type="subtext">Hook to subscribe to live contract events.</ThemedText>
      </View>
